...
export default function Certificate({
    ...
    return (
        <div className={cn(
            "bg-stone-50 text-black max-w-[800px] mx-auto",
            "print:fixed print:inset-0 print:m-0 print:p-0 print:shadow-none print:w-[100vw] print:h-[100vh] print:max-w-none print:bg-white overflow-hidden flex items-center justify-center printable-content"
        )}>
            <div className="border-[12px] border-solid border-[#1e3a8a] p-2 bg-white w-full h-full flex flex-col box-border">
                 <div className="border-[4px] border-solid border-[#eab308] p-10 relative flex flex-col items-center justify-between flex-grow box-border">
                    
                    {/* Header Section */}
                    <div className="w-full text-center space-y-1">
                        <h1 className="font-headline text-3xl print:text-5xl font-extrabold text-[#1e3a8a] uppercase tracking-tight">
                    ...
                    <div className="text-center">
                        <h2 className="text-5xl print:text-7xl font-bold text-[#b91c1c] tracking-wider uppercase leading-none" style={{ fontFamily: "'Times New Roman', serif" }}>
                    ...
                    <div className="text-center space-y-4 w-full">
                        ...
                        <div className="space-y-1">
                            <h3 className="text-4xl print:text-6xl font-black text-[#1e3a8a] tracking-wide" style={{ fontFamily: "'Times New Roman', serif" }}>
                                {studentName}
                            </h3>
                            <p className="text-lg print:text-2xl text-gray-700 font-bold">Roll Number: {rollNumber}</p>
                        </div>
                    ...
                    <div className="flex flex-col items-center py-2">
                        ...
                        <p className={`text-2xl print:text-4xl font-black mt-2 ${textColor} uppercase tracking-widest`}>{medal}</p>
                    </div>
                    ...
                    <div className="w-full flex justify-between items-end pt-8">
                        <div className="text-left space-y-1">
                            ...
                            <p className="text-xs print:text-base text-gray-500 font-mono">Cert. No: HWHS-CERT-{rollNumber}-{new Date().getFullYear()}{rank}</p>
                            <div className="pt-2">
                        ...
                        <div className="text-center w-48">
                            ...
                            <p className="font-bold text-lg print:text-2xl text-gray-900">Principal</p>
                        </div>
                    </div>
