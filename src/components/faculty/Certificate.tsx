...
export default function Certificate({
    ...
    return (
        <div className="bg-stone-50 text-black max-w-4xl mx-auto p-2 printable-content print:m-0 print:p-0 print:shadow-none print:max-w-none print:w-full print:h-full">
            <div className="border-[12px] border-solid border-blue-900 p-6 bg-white relative print:border-8 print:p-2 h-full">
                 <div className="border-[4px] border-solid border-yellow-500 p-4 relative flex flex-col print:p-2 print:border-2 h-full">
                    ...
                    <div className="relative z-10 flex flex-col flex-grow">
                        <header className="flex flex-col items-center text-center mb-2 print:mb-1">
                            <div className="w-24 h-24 print:w-16 print:h-16">
                                <Logo />
                            </div>
                            <h1 className="font-headline text-4xl print:text-4xl font-bold text-blue-900 mt-2 print:mt-1">
                        ...
                        <div className="text-center my-4 print:my-1">
                            <h2 className="text-5xl print:text-5xl font-headline font-extrabold text-red-700 tracking-wider uppercase" style={{ fontFamily: "'Times New Roman', serif" }}>
                                Certificate of Excellence
                            </h2>
                        </div>

                        <div className="text-center text-lg print:text-xl space-y-2 print:space-y-1 my-4 print:my-1 flex-grow">
                            <p>This is to certify that</p>
                            <div>
                                <h3 className="text-4xl print:text-4xl font-bold text-blue-900 tracking-wide" style={{ fontFamily: "'Times New Roman', serif" }}>
                                    {studentName}
                                </h3>
                                <p className="text-lg print:text-lg text-gray-700">Roll Number: {rollNumber}</p>
                            </div>
                            <p className="px-8 print:px-2 pt-1">
                        ...
                        <div className="flex justify-center my-4 print:my-2">
                            <div className="flex flex-col items-center text-center">
                                <div className={`relative w-28 h-28 print:w-20 print:h-20 rounded-full ${gradient} flex items-center justify-center shadow-xl ${shadow}`}>
                                    <div className="absolute inset-0 rounded-full bg-gradient-to-b from-white/30 to-transparent"></div>
                                    <span className={`font-headline text-6xl print:text-6xl font-extrabold ${textColor} drop-shadow`}>{rank}</span>
                                </div>
                                <p className={`text-3xl print:text-3xl font-bold mt-2 print:mt-1 ${textColor} drop-shadow-sm`}>{medal} Medal</p>
                            </div>
                        </div>
                    </div>
                    
                    <div className="relative z-10 pt-4 print:pt-1">
